export const createCurriedStore = (store) => {
    ...
    const selectVar =
        ...
        (name) =>
        (state) =>
            store.selectVar(stack, name, state);
    const getVar =
        (...stack) =>
        (name) =>
            store.getVar(stack, name);
    ...
    const selectNode =
        ...
        (nodeId) =>
        (state) =>
            store.selectNode(stack, nodeId, state);
    const getNode =
        (...stack) =>
        (nodeId) =>
            store.getNode(stack, nodeId);
    ...
    const selectMetadata =
        ...
        (toId) =>
        (state) =>
            store.selectMetadata(stack, edgeTypes, fromId, toId, state);
    const getMetadata =
        (...stack) =>
        (edgeTypes) =>
        (fromId) =>
        (toId) =>
            store.getMetadata(stack, edgeTypes, fromId, toId);
    ...
    const selectEdge =
        ...
        (fromId) =>
        (state) =>
            store.selectEdge(stack, edgeTypes, fromId, state);
    const getEdge =
        (...stack) =>
        (edgeTypes) =>
        (fromId) =>
            store.getEdge(stack, edgeTypes, fromId);
    const selectReverseEdge =
        (...stack) =>
        (edgeTypes) =>
        (toId) =>
        (state) =>
            store.selectReverseEdge(stack, edgeTypes, toId, state);
    const getReverseEdge =
        (...stack) =>
        (edgeTypes) =>
        (toId) =>
            store.getReverseEdge(stack, edgeTypes, toId);
    ...
    const selectRights =
        ...
        (nodeId) =>
        (state) =>
            store.selectRights(stack, nodeId, state);
    const getRights =
        (...stack) =>
        (nodeId) =>
            store.getRights(stack, nodeId);
    ...
    const selectFiles =
        ...
        (nodeId) =>
        (state) =>
            store.selectFiles(stack, nodeId, state);
    const getFiles =
        (...stack) =>
        (nodeId) =>
            store.getFiles(stack, nodeId);
    ...
    const selectView =
        ...
        (view) =>
        (state) =>
            store.selectView(stack, view, state);
