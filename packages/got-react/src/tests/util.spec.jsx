...
import { createTestComponentRedux, createTestComponentAtom, delay } from './shared.jsx';

const runTestsWith = (createTestComponent) => {
...
runTestsWith(createTestComponentRedux);
runTestsWith(createTestComponentAtom);
